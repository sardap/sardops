# Sardops Playtest Notes

## 1. Summary
**Quick summary:**  
- Goals for this session: Inital playtest
- High-level outcome:  Make game gooder
...
- **Critical (must-fix before next build):**
  1. 
